...
tar.exe -czvf deploy.tar.gz --exclude=node_modules --exclude=.next --exclude=.git --exclude=.env --exclude=public/uploads --exclude=deploy.tar.gz --exclude=deploy.zip --exclude=deploy.ps1 .

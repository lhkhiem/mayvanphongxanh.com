    ...
    <section className="py-8 bg-white border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex items-start sm:items-center justify-between gap-3 mb-4 sm:mb-5">
          ...
          <Link href="/danh-muc/goi-dich-vu" className="flex items-center gap-1 text-xs sm:text-sm font-semibold text-primary hover:text-primary/80 group shrink-0 mt-1 sm:mt-0">
            Xem tất cả
